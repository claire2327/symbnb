...
class BookingType extends ApplicationType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            // la présentation des datetypes peut être modifiée en ajoutant l'option widget
            ->add('endDate', TextType::class, $this->getConfiguration("Date de départ", "La date à laquelle vous comptez partir."))
            //->add('createdAt')
            //->add('amount')
            //->add('booker')
            //->add('ad') Le client ne doit entrer que les dates
            ...
            // false évite d'avoir un label au-dessus du commentaire
        ;
